...
program
    ...
    .description("Dispatch a ready task to an agent pipeline. Optionally specify an issue number.")
    .action(async (issue) => {
    ...
    if (!dispatched) {
        console.log("No tasks ready for dispatch. Create an issue with status:ready to get started.");
    }
});
program
